function IROCELM_visual(train_data, test_data, rho, X, Y, params)
...
hold on
% training data
ax3 = scatter(train_data(1:70,1), train_data(1:70,2), sz,'MarkerEdgeColor', 'k',...
    'MarkerFaceColor', [0 1 0]);
% testing data
ax4 = scatter(test_data(:,1), test_data(:,2), sz,'+');

% noise data
ax5 = scatter(train_data(71:80,1), train_data(71:80,2), sz, '*');
