function [train_X0, train_Y0,test_X0, test_Y0] = Preprocessing_arrhythmia

parentPath = fileparts(mfilename('fullpath'));

realData = readtable([parentPath,'\datasets\arrhythmia.data'], 'Filetype', 'text', 'ReadVariableNames', false);

attributes = [realData{:,1:13} realData{:,15:279}];
real_labels = realData{:,280};
