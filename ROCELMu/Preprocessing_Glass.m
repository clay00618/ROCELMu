function [train_X0, train_Y0,test_X0, test_Y0] = Preprocessing_Glass

%Glass
parentPath = fileparts(mfilename('fullpath'));

realData = readtable([parentPath,'\datasets\glass.data'], 'Filetype', 'text', 'ReadVariableNames', false);
...
for i=1:size(labels,1)
    if real_labels(i,1)==1 || real_labels(i,1)==2 || real_labels(i,1)==3 || real_labels(i,1)==4
        labels(i,1)=1;
    else
        labels(i,1)=-1;
    end
