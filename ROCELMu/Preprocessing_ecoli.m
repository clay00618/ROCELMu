function [train_X0, train_Y0,test_X0, test_Y0] = Preprocessing_ecoli

%Ecoli

parentPath = fileparts(mfilename('fullpath'));

realData = readtable([parentPath,'\datasets\ecoli.data'], 'Filetype', 'text', 'ReadVariableNames', false);
